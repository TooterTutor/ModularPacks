...
import io.github.tootertutor.SophiBackpacks.config.Placeholders;
import io.github.tootertutor.SophiBackpacks.config.UpgradeDef;
...
public final class UpgradeItems {
    ...
    public UpgradeItems(SophiBackpacksPlugin plugin) {
        this.plugin = plugin;
    }
