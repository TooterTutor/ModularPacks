...
public final class ConfigManager {
    ...
    public ConfigManager(SophiBackpacksPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    public void reload() {
        ...
        resizeGui = cfg.getBoolean("SophiBackpacks.ResizeGUI", false);
        debugClickLog = cfg.getBoolean("SophiBackpacks.Debug.ClickLog", false);

        navPageButtons = mat(cfg.getString("SophiBackpacks.NavPageButtons", "ARROW"), Material.ARROW);
        navBorderFiller = mat(cfg.getString("SophiBackpacks.NavBorderFiller", "GRAY_STAINED_GLASS_PANE"),
                Material.GRAY_STAINED_GLASS_PANE);
        unlockedUpgradeSlotMaterial = mat(
                cfg.getString("SophiBackpacks.UnlockedUpgradeSlotMaterial", "WHITE_STAINED_GLASS_PANE"),
                Material.WHITE_STAINED_GLASS_PANE);
        lockedUpgradeSlotMaterial = mat(
                cfg.getString("SophiBackpacks.LockedUpgradeSlotMaterial", "IRON_BARS"),
                Material.IRON_BARS);
