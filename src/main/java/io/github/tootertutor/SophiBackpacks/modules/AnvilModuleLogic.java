...
public final class AnvilModuleLogic {
    ...
    public static void open(SophiBackpacksPlugin plugin, Player player,
     ...
     */
    public static void handleClose(SophiBackpacksPlugin plugin, Player player, Inventory inv) {
