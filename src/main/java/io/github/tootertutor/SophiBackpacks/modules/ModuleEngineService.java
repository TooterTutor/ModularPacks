...
public final class ModuleEngineService {
    ...
    public ModuleEngineService(SophiBackpacksPlugin plugin) {
        this.plugin = plugin;
    }
    ...
    private void tickFurnaceScreen(Player player, ModuleScreenHolder msh, Inventory inv) {
        ...
        // Bukkit's property API only applies to InventoryType.FURNACE; blast furnace & smoker need direct container-data packets.
    ...
    /**
     * Sends container data updates for furnace-like menus, including blast furnace and smoker.
    ...
    private static final class ContainerDataSync {
        ...
        static void trySyncFurnaceLike(Player player, int burnTime, int burnTotal, int cookTime, int cookTotal) {
            ...
            try {
                ...
                // 0 = burnTime (litTime), 1 = burnTotal (litDuration), 2 = cookTime, 3 = cookTotal
        ...
        private static void ensureInit() {
            ...
            synchronized (ContainerDataSync.class) {
                ...
                try {
                    ...
                    Class<?> connectionClazz = Class.forName("net.minecraft.server.network.ServerGamePacketListenerImpl");
