...
public final class FeedingModuleDeclaration extends AbstractModuleDeclaration {

	public FeedingModuleDeclaration() {
		super(
				"Feeding",
				"Feeding Module",
				ScreenType.DROPPER,
				new ModuleScreenDeclaration(
						...
						ScreenDefinition.typed(ScreenType.DROPPER, InventoryType.DROPPER,
								(screenType, moduleType, filterMode) -> "BLACKLIST".equalsIgnoreCase(filterMode)
										? "Feeding Blacklist"
										: "Feeding Whitelist")));
	}
}
